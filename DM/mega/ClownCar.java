 ...
 */
public class ClownCar extends AdvancedRobot
{
	static final int DISPLAY_HEIGHT = 100, DISPLAY_WIDTH = 168,
		DISPLAY_X = 0, DISPLAY_Y = 0;

	//private static BanHammer gun; //BanHammer
	private static MagicStick gun;
	
	private static Legs rimjob;
	...
	public static Path2D.Double getRaceTrack() {
	...
	public void run() {
		...
		setColors(Color.RED.brighter(),Color.WHITE.brighter().brighter().brighter(),Color.RED.brighter()); // body,gun,radar
	...
	public void onScannedRobot(final ScannedRobotEvent e) {
		...
		if(!isMC) {
			...
			rimjob.update(e, liveShots, absBearing);
		}
	}
